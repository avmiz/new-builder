...
sendInfo "starting build EmptyGlory-H-RC Q . . ."
...
sendInfo "build EmptyGlory-H-RC Q done . . ."
...
sendInfo "starting build EmptyGlory-H-RC P . . ."
...
sendInfo "build EmptyGlory-H-RC P done . . ."
...
sendInfo "starting build EmptyGlory-H-RC Q SAR . . ."
...
sendInfo "build EmptyGlory-H-RC Q SAR done . . ."