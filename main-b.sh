...
function makeZip(){
    ...
    ZipName="$TypeFor$Type[$TANGGAL]$ZIP_KERNEL_VERSION-$KERNEL_NAME-$HeadCommit-HZ-100.zip"
...
function build(){
    ...
    if [[ "$1" == *"Avalon"* ]];then
        ...
        update_file "CONFIG_HZ=" "CONFIG_HZ=100" "./arch/arm64/configs/X01BD_defconfig"
    elif [[ "$1" == *"GCC"* ]];then
