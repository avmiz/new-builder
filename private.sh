...
################################################################################################ Custom Kernel
    ...
    makeCleanOnly
    # build "QAvalonTest60Hz" "" "$chat_group_id" "$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)-ZyC"
    ...
    makeCleanOnly
    # build "PAvalonTest60Hz" "" "$chat_group_id" "$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)-ZyC" >/dev/null
